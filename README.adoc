...
. Download Vault 0.11.1 from the https://www.vaultproject.io/downloads.html[download page]
to the git project directory

The Ansible Tower Vagrant Box 3.3.0 with Ansible 2.6.3 was used to create this demo.
